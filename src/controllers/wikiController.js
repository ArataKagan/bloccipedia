...
module.exports = {
    ...
    edit(req, res, next){
        wikiQueries.getWiki(req.params.id, (err, wiki) => {
            if(err || wiki == null){
                ...
                isCollabo((nonCollaboMember, collaboMember) => {
                    const authorized = new Authorizer(nonCollaboMember, wiki, collaboMember).edit();
                    if(authorized){
    ...
    update(req, res, next){
        ...
        isCollabo((nonCollaboMember, collaboMember) => {
            const authorized = new Authorizer(nonCollaboMember, req.params.id, collaboMember).update();
            if(authorized){
